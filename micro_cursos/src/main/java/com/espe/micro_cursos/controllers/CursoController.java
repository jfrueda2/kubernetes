    ...
    public class CursoController {
        ...
        public ResponseEntity<String> deleteById(@PathVariable Long id) {
            ...
            if (cursoExistente.isPresent()) {
                ...
                return new ResponseEntity<>("Curso eliminado correctamente", HttpStatus.OK); // Cambié el código de estado a OK
            } else {
                return new ResponseEntity<>("Curso no ubicado", HttpStatus.NOT_FOUND);
            }
        }
        ...
        public ResponseEntity<?> addUser(@PathVariable Long id, @RequestBody Usuario usuario) {
            ...
            try{
                ...
                return ResponseEntity.status(HttpStatus.NOT_FOUND).body(Collections.singletonMap("error", "Usuario no ubicado" + ex.getMessage()));
            }
        ...
        public ResponseEntity<String> removeUser(@PathVariable Long cursoId, @PathVariable Long usuarioId) {
            ...
            if (removed) {
                return new ResponseEntity<>("Usuario desmatriculado correctamente", HttpStatus.OK); // Mensaje de éxito
            } else {
                return new ResponseEntity<>("Usuario no ubicado en el curso", HttpStatus.NOT_FOUND); // Mensaje de error
            }
        }
    }
